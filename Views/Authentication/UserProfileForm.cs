...
namespace HospitalAutomation.Views.Authentication
{
    public partial class UserProfileForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBoxInfo.Text = "Ki�isel Bilgiler";
        ...
        private void LoadUserData()
        {
            if (SessionManager.IsStaffLogin)
            {
                ...
                // Kullan�c� t�r�n� T�rk�e olarak g�ster
                switch (user.Role)
                {
                    ...
                    case HospitalAutomation.Models.Enums.UserRole.Nurse:
                        lblUserTypeValue.Text = "Hem�ire";
                        break;
                    case HospitalAutomation.Models.Enums.UserRole.Admin:
                        lblUserTypeValue.Text = "Y�netici";
                        break;
            ...
            {
                MessageBox.Show($"Servis ba�lat�l�rken hata olu�tu: {ex.Message}", "Hata", 
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Ad ve Soyad alanlar� bo� b�rak�lamaz!", "Uyar�", 
                ...
                if (SessionManager.IsStaffLogin)
                {
                    ...
                    MessageBox.Show("Profil bilgileriniz ba�ar�yla g�ncellendi!", "Ba�ar�l�", 
            ...
            {
                MessageBox.Show($"Profil g�ncellenirken hata olu�tu: {ex.Message}", "Hata", 
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
