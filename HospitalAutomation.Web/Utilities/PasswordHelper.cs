...
namespace HospitalAutomation.Utilities
{
    public static class PasswordHelper
    {
        ...
        private const string LegacySalt = "HospitalSalt2024"; // eski yöntemi tanımak/verifikasyon için
        ...
        /// <summary>
        /// Parolayı storedHash ile doğrular. Eski SHA256+fixed-salt formatı da desteklenir.
        /// </summary>
        public static bool VerifyPassword(string password, string storedHash)
        {
            ...
            try
            {
                ...
                {
                    // Muhtemel legacy SHA256(base + fixed salt) formatı
        ...
        /// <summary>
        /// Eğer storedHash legacy formatındaysa veya düşük iterasyon içeriyorsa yeniden hashlenmeli.
        /// </summary>
